...
- Measurement ownership: [`profiling`](../../../ws1/m03gtjqkhqacstl3luv2ojsz3q_profiling/AGENTS.md) owns timing, latest-metric replacement, storage, and deferred reporting. The renderer owns its metrics and runtime attachment integration. Its benchmark driver owns workloads, repeated-run summaries, and comparisons; applications own shared profiler instances.
