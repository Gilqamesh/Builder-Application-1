...
- Measurement ownership: [`profiling`](../../../ws1/m03gtjqkhqacstl3luv2ojsz3q_profiling/AGENTS.md) owns timing statistics, latest-data replacement, storage, and deferred reporting. Each renderer owns its metrics and a profiler with runtime enablement. Its benchmark driver owns workloads, repeated-run summaries, and comparisons; applications may use the renderer's profiler for their own measurements.
