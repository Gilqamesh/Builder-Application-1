...
template <typename T>
using scalar_t = typename shader::shader_type_traits_t<T>::scalar_type_t;
template <typename T>
...
struct formatter<m03gt1djvvy5atia5evkbg6rqy_software_shader::operand_kind_t> {
    ...
    auto format(const m03gt1djvvy5atia5evkbg6rqy_software_shader::operand_kind_t& operand_kind, auto& context) const {
        auto out = context.out();
        out = std::format_to(out, "{}", static_cast<int>(operand_kind));
        return out;
    }
};
...
struct formatter<m03gt1djvvy5atia5evkbg6rqy_software_shader::opcode_t> {
    constexpr auto parse(std::format_parse_context& context) { return context.begin(); }
    auto format(const m03gt1djvvy5atia5evkbg6rqy_software_shader::opcode_t& opcode, auto& context) const {
        auto out = context.out();
        out = std::format_to(out, "{}", static_cast<int>(opcode));
        return out;
    }
};
...
struct formatter<m03gt1djvvy5atia5evkbg6rqy_software_shader::operand_t> {
    constexpr auto parse(std::format_parse_context& context) { return context.begin(); }
    auto format(const m03gt1djvvy5atia5evkbg6rqy_software_shader::operand_t& operand, auto& context) const {
        auto out = context.out();
        out = std::format_to(out, "{}", operand.kind);
        out = std::format_to(out, ":{}", operand.index);
        return out;
    }
};
...
struct formatter<m03gt1djvvy5atia5evkbg6rqy_software_shader::instruction_t> {
    constexpr auto parse(std::format_parse_context& context) { return context.begin(); }
    auto format(const m03gt1djvvy5atia5evkbg6rqy_software_shader::instruction_t& instruction, auto& context) const {
        auto out = context.out();
        out = std::format_to(out, "opcode={}", instruction.opcode);
        out = std::format_to(out, " operands={}", instruction.operand_begin);
        out = std::format_to(out, "+{}", instruction.operand_count);
        out = std::format_to(out, " kernel={}", instruction.kernel_index);
        return out;
    }
};
...
struct formatter<m03gt1djvvy5atia5evkbg6rqy_software_shader::stage_code_t> {
    constexpr auto parse(std::format_parse_context& context) { return context.begin(); }
    auto format(const m03gt1djvvy5atia5evkbg6rqy_software_shader::stage_code_t& stage_code, auto& context) const {
        auto out = context.out();
        out = std::format_to(out, "instructions={}", stage_code.instructions().size());
        out = std::format_to(out, " operands={}", stage_code.operands().size());
        out = std::format_to(out, " slots={}", stage_code.slot_count());
        out = std::format_to(out, " locals={}", stage_code.local_count());
        out = std::format_to(out, " storage_bytes={}", stage_code.storage_bytes());
        return out;
    }
};
...
struct formatter<m03gt1djvvy5atia5evkbg6rqy_software_shader::prepared_invocation_t> {
    ...
    auto format(const m03gt1djvvy5atia5evkbg6rqy_software_shader::prepared_invocation_t& invocation, auto& ctx) const {
        auto out = ctx.out();
        out = std::format_to(out, "inputs={}", invocation.inputs.size());
        out = std::format_to(out, " outputs={}", invocation.outputs.size());
        return out;
    }
};
...
struct formatter<m03gt1djvvy5atia5evkbg6rqy_software_shader::kernel_operation_t> {
    constexpr auto parse(std::format_parse_context& context) { return context.begin(); }
    auto format(const m03gt1djvvy5atia5evkbg6rqy_software_shader::kernel_operation_t& kernel_operation, auto& context) const {
        auto out = context.out();
        out = std::format_to(out, "{}", static_cast<int>(kernel_operation));
        return out;
    }
};
...
struct formatter<m03gt1djvvy5atia5evkbg6rqy_software_shader::kernel_arguments_t> {
    constexpr auto parse(std::format_parse_context& context) { return context.begin(); }
    auto format(const m03gt1djvvy5atia5evkbg6rqy_software_shader::kernel_arguments_t& kernel_arguments, auto& context) const {
        auto out = context.out();
        out = std::format_to(out, "slots={}", kernel_arguments.slots.size());
        out = std::format_to(out, " operands={}", kernel_arguments.operands.size());
        return out;
    }
};
...
struct formatter<m03gt1djvvy5atia5evkbg6rqy_software_shader::kernel_entry_t> {
    constexpr auto parse(std::format_parse_context& context) { return context.begin(); }
    auto format(const m03gt1djvvy5atia5evkbg6rqy_software_shader::kernel_entry_t& kernel_entry, auto& context) const {
        auto out = context.out();
        out = std::format_to(out, "operation={}", kernel_entry.operation);
        return out;
    }
};
...
struct formatter<m03gt1djvvy5atia5evkbg6rqy_software_shader::loop_t> {
    constexpr auto parse(std::format_parse_context& context) { return context.begin(); }
    auto format(const m03gt1djvvy5atia5evkbg6rqy_software_shader::loop_t& loop, auto& context) const {
        auto out = context.out();
        out = std::format_to(out, "condition={}", loop.condition);
        out = std::format_to(out, " breaks={}", loop.breaks.size());
        return out;
    }
};
...
struct formatter<m03gt1djvvy5atia5evkbg6rqy_software_shader::compiler_t> {
    constexpr auto parse(std::format_parse_context& context) { return context.begin(); }
    auto format(const m03gt1djvvy5atia5evkbg6rqy_software_shader::compiler_t& compiler, auto& context) const {
        auto out = context.out();
        out = std::format_to(out, "instructions={}", compiler.instructions.size());
        out = std::format_to(out, " slots={}", compiler.slot_count);
        out = std::format_to(out, " locals={}", compiler.local_count);
        return out;
    }
};
